...
class Matchers {
   ...
   * Get element by ID.
   *
   * @deprecated Use getElementByID from e2e/framework/Matchers.ts instead for better error handling and retry mechanisms
   ...
   * Get element by text.
   *
   * @deprecated Use getElementByText from e2e/framework/Matchers.ts instead for better error handling and retry mechanisms
   ...
   *
   * @deprecated Use getElementByIDAndLabel from e2e/framework/Matchers.ts instead for better error handling and retry mechanisms
   ...
   *
   * @deprecated Use getElementByLabel from e2e/framework/Matchers.ts instead for better error handling and retry mechanisms
   ...
   *
   * @deprecated Use getElementByDescendant from e2e/framework/Matchers.ts instead for better error handling and retry mechanisms
   ...
   *
   * @deprecated Use getElementIDWithAncestor from e2e/framework/Matchers.ts instead for better error handling and retry mechanisms
   * @param {string} childElement - The ID of the child element to locate within the parent element.
   * @param {string} parentElement - Matches elements with at least one descendant that matches the specified matcher.
   * @return {Promise<Detox.IndexableNativeElement>} - Resolves to the located element
   */
   ...
   *
   * @deprecated Use getElementByWebID from e2e/framework/Matchers.ts instead for better error handling and retry mechanisms
   ...
   * @deprecated Use getElementByCSS from e2e/framework/Matchers.ts instead for better error handling and retry mechanisms
   ...
   * @deprecated Use getElementByXPath from e2e/framework/Matchers.ts instead for better error handling and retry mechanisms
   * @param {string} webviewID - The web ID of the browser webview
  ...
  /**
   * Get element by href.
   * @deprecated Use getElementByHref from e2e/framework/Matchers.ts instead for better error handling and retry mechanisms
   * @param {string} webviewID - The web ID of the browser webview
 ...
 *
 * @deprecated Use getIdentifier from e2e/framework/Matchers.ts instead for better error handling and retry mechanisms
 ...
 */
   ...
   *
   * @deprecated Use getSystemElementByText from e2e/framework/Matchers.ts instead for better error handling and retry mechanisms
   * @param {string} text - Match elements with the specified text
